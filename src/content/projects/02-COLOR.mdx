...
coverImage:
  {
    url: "../../assets/projectImg/COLOR/cover.webp",
...
support:
  [
    {
      url: "../../assets/projectImg/COLOR/01-support.jpg",
      alt: "Nationales Performance Netz Logo",
    },
    { url: "../../assets/projectImg/COLOR/02-support.JPG", alt: "Neustart Kultur Logo" },
    {
      url: "../../assets/projectImg/COLOR/03-support.png",
      alt: "Die Beauftragte der Bundesregierung für Kultur und Medien Logo",
    },
    {
      url: "../../assets/projectImg/COLOR/04-support.jpg",
      alt: "Ministry of Culture - Republic of china (Taiwan) Logo",
    },
    { url: "../../assets/projectImg/COLOR/05-support.png", alt: "WIESE Logo" },
  ]
thanks:
  [
    { url: "../../assets/projectImg/COLOR/02-thanks.jpg", alt: "CND Logo" },
    {
      url: "../../assets/projectImg/COLOR/03-thanks.png",
      alt: "thessaloniki cinedance international Logo",
    },
    { url: "../../assets/projectImg/COLOR/04-thanks.png", alt: "die Wolke art group Logo" },
    { url: "../../assets/projectImg/COLOR/05-thanks.png", alt: "pflanzmich.de Logo" },
    { url: "../../assets/projectImg/COLOR/06-thanks.jpg", alt: ".skg STAY Logo" },
  ]
videos:
  [
    {
...
import color2 from '../../assets/projectImg/COLOR/color-2.webp';
import color3 from '../../assets/projectImg/COLOR/color-3.webp';
import color4 from '../../assets/projectImg/COLOR/color-4.webp';
import colorPoster from '../../assets/projectImg/COLOR/poster.webp';
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/916719371?h=3b79442890&autoplay=1&muted=1" title="COLOR ⾊ — Performance Trailer" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/826468069?h=89646c9918&autoplay=1&loop=1&muted=1" title="COLOR ⾊ — Rehearsal Excerpt" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<Image src={color2} alt="Dancer with hand-mounted cameras performing under pink and purple light with real-time projections during COLOR interactive dance performance, photograph by Tobias Hoops" />
...
<Image src={color3} alt="Audience silhouettes standing between large projection screens displaying surveillance film imagery in red light during COLOR dance performance, photograph by I-Chun Chen" />
<Image src={color4} alt="Dancer silhouette with raised fist projected onto screen under purple lighting with audience member watching the COLOR observation and surveillance performance, photograph by I-Chun Chen" />
...
<Image src={colorPoster} alt="Official poster for COLOR dance performance by Jasmine Fan at WIESE Hamburg May 2023 featuring close-up face profile with digital glitch effects" />
