...
coverImage:
  {
    url: "../../assets/projectImg/AWMS/cover.webp",
...
import awms1 from '../../assets/projectImg/AWMS/awms-1.webp';
import awms2 from '../../assets/projectImg/AWMS/awms-2.webp';
import awms3 from '../../assets/projectImg/AWMS/awms-3.webp';
...
<Image src={awms1} alt='Scenes from the film "A walk in Mermaid&#39;s Shoes"' />
<br />

<Image src={awms2} alt='Scenes from the film "A walk in Mermaid&#39;s Shoes"' />
<br />

<Image src={awms3} alt='Scenes from the film "A walk in Mermaid&#39;s Shoes"' />
<br />

<br />
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/290874719?h=b50ade0d99&autoplay=1&loop=1&title=0&byline=0&portrait=0&muted=1" title="A Walk in Mermaid's Shoes — Dance Film" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br />
